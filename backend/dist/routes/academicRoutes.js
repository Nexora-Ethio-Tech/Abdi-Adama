...
import { getGrades, createGrade, getSectionsByGrade, getGradesWithSections, createSection, bulkCreateSections, updateSection, deleteSection, getStudentsBySection } from '../controllers/academicController.js';
const router = Router();
