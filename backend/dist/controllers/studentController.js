...
export const createStudent = async (req, res) => {
    const { name, email, password, digital_id, branch_id, grade, dob, gender, parent_name, parent_phone, emergency_contacts } = req.body;
    try {
        const result = await withRLS(req, async (client) => {
         ...
         VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id`, [userId, branch_id, grade, dob, gender, parent_name, parent_phone]);
